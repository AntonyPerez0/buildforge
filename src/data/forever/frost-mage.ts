...
export const frostMage: Build = {
  ...
  gear: [
    {
      slot: "Head",
      target: "Cloth with spell damage + int — Arcanist Crown when raids open",
      affixes: ["Spell Damage", "Intellect", "Crit"],
      item: {
        name: "Arcanist Crown",
        quality: "epic",
        ...
        source: "Molten Core · Arcanist",
        icon: "helm",
      },
    },
    {
      slot: "Neck",
      target: "Caster necklace with stam",
      affixes: ["Spell Damage", "Intellect", "Stamina"],
      item: {
        name: "Frostwoven Pendant",
        quality: "rare",
        type: "Rare Necklace",
        stats: [
          { text: "+8 Intellect" },
          { text: "+5 Stamina" },
          { text: "+13 Frost Spell Damage" },
        ],
    ...
    {
      slot: "Shoulders",
      target: "Reworked dungeon caster drops — Arcanist Mantle when raids open",
    ...
    {
      slot: "Wrists",
      target: "Spell damage bracers — enchant immediately",
      affixes: ["Spell Damage", "Intellect"],
      item: {
        name: "Arcanist Bindings",
        quality: "epic",
        type: "Epic Cloth Bracers",
        armor: "58 Armor",
        stats: [
          { text: "+14 Intellect" },
          { text: "+9 Frost Spell Damage" },
        ],
        source: "Molten Core · Arcanist",
        icon: "wrist",
      },
    ...
    {
      slot: "Hands",
      target: "Spell damage or crit gloves",
    ...
    },
    {
      ...
      item: {
        ...
        quality: "epic",
        type: "Epic Cloth Legs",
        armor: "102 Armor",
        stats: [
          { text: "+22 Intellect" },
          { text: "+10 Spirit" },
          { text: "+26 Frost Spell Damage" },
        ],
        source: "Molten Core · Arcanist",
        icon: "legs",
      },
    ...
    {
      slot: "Feet",
      target: "Minor Speed enchant — kiting is life",
      affixes: ["Intellect", "Movement via enchant"],
      item: {
        name: "Arcanist Boots",
        quality: "epic",
        type: "Epic Cloth Boots",
        armor: "70 Armor",
        stats: [
          { text: "+16 Intellect" },
          { text: "+14 Frost Spell Damage" },
    ...
    },
    {
      ...
      affixes: ["Spell Damage", "Intellect", "Hit"],
      item: {
        name: "Band of Concentrated Frost",
        quality: "rare",
        type: "Rare Ring",
        stats: [
          { text: "+6 Intellect" },
          { text: "+1% Hit Chance" },
          { text: "+10 Frost Spell Damage" },
        ],
        source: "New-dungeon drops — verify itemization guide",
        icon: "ring",
      },
    ...
    {
      slot: "Trinket 1",
      target: "Flat spell power — the new dungeons feed caster trinkets",
      affixes: ["Spell Power", "On-use effects"],
      item: {
        name: "Icebound Spell Trinket",
        quality: "rare",
        type: "Rare Trinket",
        stats: [
          { text: "Equip: +18 Frost Spell Damage.", tone: "power" },
          { text: "+9 Intellect" },
        ],
        source: "New-dungeon drops — verify itemization guide",
        icon: "trinket",
    ...
    {
      slot: "Trinket 2",
      target: "Crit or on-use burst for Shatter windows",
      affixes: ["Crit", "On-use effects"],
      item: {
        name: "Talisman of the Shattered Glacier",
        quality: "rare",
        type: "Rare Trinket",
        stats: [
        ...
        flavor: "Shatter already tripled your crit against frozen targets — this pushes the ceiling.",
        source: "New-dungeon drops — verify itemization guide",
        icon: "trinket",
      },
    },
    {
      slot: "Main Hand",
      target: "Highest spell-damage staff available — new-dungeon caster weapons were fully reworked, check the itemization guide for the current BiS list; Staff of Dominance is the raid-era dream",
      affixes: ["Spell Damage", "Intellect"],
      item: {
        ...
        flavor: "The caster stat-stick dream — wand weaving between Frostbolts does the rest.",
        source: "Raid target — verify new-dungeon drops",
        icon: "staff",
      },
    },
    {
    ...
    {
      slot: "Ranged",
      target: "Wand with damage — wand weaving saves mana between casts",
      affixes: ["Damage", "Spell Damage"],
      item: {
        name: "Mana-Igniting Wand",
        quality: "rare",
        type: "Rare Wand",
        stats: [
          { text: "18–34 Arcane Damage" },
          { text: "+1% Spell Hit Chance" },
        ],
        flavor: "Wand weaving between Frostbolts keeps the mana bar honest during Blizzard waves.",
        source: "New-dungeon drops — verify itemization guide",
        icon: "wand",
      },
    },
