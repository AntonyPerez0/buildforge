...
export const combatRogue: Build = {
  ...
  gear: [
    { slot: "Head", target: "Leather with agility/hit", affixes: ["Agility", "Hit", "Stamina"] },
    { slot: "Shoulders", target: "Reworked dungeon drops", affixes: ["Agility", "Attack Power"] },
    { slot: "Chest", target: "Agility stat-stick", affixes: ["Agility", "Stamina", "Crit"] },
    { slot: "Wrists", target: "Cheap agility upgrades — enchant on arrival", affixes: ["Agility", "Stamina"] },
    { slot: "Hands", target: "Hit or crit gloves", affixes: ["Hit", "Crit", "Agility"] },
    { slot: "Waist", target: "Any clean agility leather", affixes: ["Agility", "Stamina"] },
    { slot: "Legs", target: "Armor-kit immediately", affixes: ["Agility", "Stamina"] },
    { slot: "Feet", target: "Minor Speed enchant", affixes: ["Stamina", "Movement via enchant"] },
    { slot: "Weapons", target: "Two swords — slow high-damage main hand, fast off-hand", affixes: ["Slow main hand", "Fast off-hand", "Crusader on main"], unique: "Sinister Strike uses main-hand damage — the slow sword upgrade is always the biggest jump." },
    { slot: "Ranged", target: "Throwing weapons with stats", affixes: ["Agility", "Hit"] },
    { slot: "Trinkets", target: "Flat attack power or on-use burst", affixes: ["Attack Power", "On-use effects"] },
    { slot: "Rings", target: "Agility + hit pairing", affixes: ["Agility", "Hit", "Crit"] },
    { slot: "Necklace", target: "Agility with stamina", affixes: ["Agility", "Stamina", "Hit"] },
  ],
  rotation: [
    {
      phase: "Pull",
