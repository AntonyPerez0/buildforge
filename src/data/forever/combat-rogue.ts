...
export const combatRogue: Build = {
  ...
  talentRuns: [
    { from: 10, to: 11, name: "Improved Sinister Strike", rankFrom: 1 },
    { from: 12, to: 14, name: "Improved Eviscerate", rankFrom: 1 },
    { from: 15, to: 17, name: "Ruthlessness", rankFrom: 1 },
    { from: 18, to: 18, name: "Relentless Strikes", rankFrom: 1 },
    { from: 19, to: 23, name: "Precision", rankFrom: 1 },
    { from: 24, to: 24, name: "Dual Wield Specialization", rankFrom: 1 },
    { from: 25, to: 25, name: "Forever 16-point capstone", rankFrom: 1, note: "verify in beta calculator" },
    { from: 26, to: 29, name: "Dual Wield Specialization", rankFrom: 2 },
    { from: 30, to: 30, name: "Blade Flurry", rankFrom: 1 },
    { from: 31, to: 31, name: "Riposte", rankFrom: 1 },
    { from: 32, to: 35, name: "Malice", rankFrom: 1 },
    { from: 36, to: 39, name: "Lethality", rankFrom: 1 },
    { from: 40, to: 40, name: "Adrenaline Rush", rankFrom: 1 },
    { from: 41, to: 41, name: "Malice", rankFrom: 5 },
    { from: 42, to: 42, name: "Lethality", rankFrom: 5 },
    { from: 43, to: 44, name: "Improved Sprint", rankFrom: 1 },
  ],
  endgame: [
    {
