...
export const twistingBladesRogue: Build = {
  ...
  gear: [
    ...
    },
    {
      ...
      unique: "Grasp of Shadow (unique gloves) if the Lair-boss lottery pays out — re-check its exact effect in the live guides before committing.",
    },
    {
      slot: "Amulet",
    ...
    },
    {
      ...
      unique: "Aspect of the Expectant on a ring is the classic pairing.",
    },
  ],
  rotation: [
    {
