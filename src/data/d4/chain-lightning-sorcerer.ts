...
export const chainLightningSorcerer: Build = {
  ...
  gear: [
    ...
    {
      slot: "Weapons",
      target: "Staff (or Wand + Focus)",
      affixes: ["Intelligence", "Critical Strike Damage", "Critical Strike Chance", "Damage to Close Enemies"],
      unique: "The Oculus (unique staff) if the Lair-boss lottery pays out — re-check its exact effect in the live guides before committing.",
    },
    {
      slot: "Amulet",
    ...
    },
    {
      ...
      unique: "Tal Rasha's Iridescent Loop on one ring once your rotation touches more than one element.",
    },
  ],
  rotation: [
    {
